...
PROJECT_NAME ?= provider-elastic-cloud
PROJECT_REPO ?= github.com/jaylevin/$(PROJECT_NAME)
...
#https://github.com/elastic/terraform-provider-ec/releases/download/v0.9.0/terraform-provider-ec_0.9.0_linux_amd64.zip
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= $(TERRAFORM_PROVIDER_REPO)/releases/download/v$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-ec_0.9.0
...
xpkg.build.provider-elastic-cloud: do.build.images
...
#   You can check the basic implementation here: https://github.com/upbound/uptest/blob/main/internal/elastic-clouds/01-delete.yaml.tmpl.
